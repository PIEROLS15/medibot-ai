...
import { MedicalResponse, UserData } from '@/types/recommendation'
...
export default function RecommendationResult({
    ...
    const { recs, reason, hasRecommendations, isGeneratingPDF, handleGeneratePDF } = useRecommendationResult(recommendations, userData)
