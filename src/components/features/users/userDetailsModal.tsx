            ...
            <DialogContent className="sm:max-w-md w-[95vw] max-w-lg mx-auto dark:bg-gray-900 dark:border-gray-800 max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <UserInfoRow icon={<Mail className="h-5 w-5 text-gray-500 dark:text-gray-400" />} title="Correo Electrónico" value={user.email} />
                        <UserInfoRow icon={<Shield className="h-5 w-5 text-gray-500 dark:text-gray-400" />} title="Rol del Sistema" value={getNameRoleUser(user.role.name)} />
                        <UserInfoRow icon={<Calendar className="h-5 w-5 text-gray-500 dark:text-gray-400" />} title="Fecha de Registro" value={formatDate(user.createdAt)} />
                        <UserInfoRow icon={<Calendar className="h-5 w-5 text-gray-500 dark:text-gray-400" />} title="Ultima modificación" value={formatDate(user.updatedAt)} />
                        <UserInfoRow
                            icon={<Activity className="h-5 w-5 text-gray-500 dark:text-gray-400" />}
